      ...
      >
        ...
        >
          <template slot-scope="scope">
            ...
            >修改提交</span>
            <span
              v-if="scope.row.approveType === 'add'"
              class="increase-tag"
            >新增提交</span>
          </template>
        </el-table-column>
        ...
        > 
          <!-- 专题查看 -->
          <template slot-scope="scope">
            <Special :approvedId="scope.row.id"></Special>
          </template>
        </el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    handleCurrentChange(val) {
      ...
      this.getApprovedSpecialList()
    },
    getApprovedSpecialList() {
      const url = "/api/todoProject/projectApproved";
      this.$http
